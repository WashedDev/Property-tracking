...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8 flex items-center gap-5 glass-panel px-6 py-4 rounded-3xl w-fit animate-fade-in-up">
            <img src="{{ asset('images/ctech-int-logo.png') }}" alt="Ctech Systems Logo"
                class="h-12 w-auto object-contain transform hover:rotate-6 transition duration-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div
                class="glass-panel rounded-3xl p-6 relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-fade-in-up delay-100">
            ...
            <div
                class="glass-panel rounded-3xl p-6 relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-fade-in-up delay-200">
            ...
            <div
                class="glass-panel rounded-3xl p-6 relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-fade-in-up delay-300">
        ...
        <div
            class="glass-panel rounded-3xl overflow-hidden relative border border-white/60 min-h-[400px] animate-fade-in-up delay-400">
            <div
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm">
                        @forelse($users as $index => $user)
                            <tr class="border-b border-gray-100/50 hover:bg-white/60 transition-all duration-300 group hover:scale-[1.01] transform cursor-default animate-fade-in-up"
                                style="animation-delay: {{ 400 + ($index * 100) }}ms;">
                                <td class="p-5">
                                    <div class="flex items-center gap-4">
                                        <div
                                            class="w-12 h-12 rounded-2xl bg-gradient-to-br from-ctech-cyan to-ctech-green flex items-center justify-center text-white font-bold shadow-md text-lg transform group-hover:rotate-12 transition duration-500">
                                            {{ substr($user->name, 0, 1) }}
                                        </div>
                                        <div>
                                            <div
                                                class="font-bold text-ctech-dark text-base group-hover:text-ctech-cyan transition duration-300">
                                                {{ $user->name }}
                                            </div>
                                ...
                                <td class="p-5 text-center">
                                    <span
                                        class="inline-flex items-center px-4 py-1.5 rounded-full bg-white/80 text-ctech-cyan border border-ctech-cyan/20 font-bold text-xs shadow-sm transform group-hover:scale-105 transition duration-300">
                                ...
                                <td class="p-5 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('admin.contract', $user->id) }}"
                                            class="inline-flex items-center gap-2 btn-ctech px-5 py-2.5 rounded-xl text-sm font-semibold transition shadow-md hover:-translate-y-1 hover:shadow-lg">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="p-20 text-center animate-fade-in-up delay-500">
                                    <div
                                        class="text-gray-300 text-6xl mb-4 opacity-70 transform hover:scale-110 transition duration-500">
                                        👥</div>
